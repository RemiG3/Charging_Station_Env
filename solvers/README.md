...
for num in 50 60 70 90 120 150; do
  python rb_main.py \
    ...
    --reset 1 \
    --simulation_args nb_predict_timestep=3,pv_model_path='../pv_predictions/xgboost_pv_model_3min.json',input_window_pv=5,price_model_path=None,input_window_price=0
done
...
for num in 50 60 70 90 120 150; do
  python rolling_main.py \
    --simulation Simulate_Station_FIFO \
    --action Simulate_Actions_FIFO \
    --simulation_args nb_predict_timestep=3,pv_model_path='../pv_predictions/xgboost_pv_model_3min.json',input_window_pv=5,price_model_path=None,input_window_price=0 \
    --current_folder ../../dataset/ev_scenario-"$num"/ \
