...
class Simulate_Station_FIFO_without_Price_Prediction(Simulate_Station_Base):
    """
    Initializes the class.
    """
    def __init__(self, nb_predict_timestep: int=3, pv_model_path: str=None, price_model_path: str=None):
        super().__init__()
    ...
    def get_observation_size(self, env: Type[gym.Env]) -> int:
        size = 2 + abs(self.nb_predict_timestep) + 6 * env.number_of_chargers
