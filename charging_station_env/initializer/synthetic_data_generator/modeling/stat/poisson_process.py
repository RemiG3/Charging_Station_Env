...
class poisson_process:
    ...
    def avg_scale_pred(self,year,poles):
        return self.scale_multiplier_predictor.predict(np.array([year,
                                                                 np.array(self.poles_fun([poles]))], dtype=object).reshape(1, -1))
    ...
    def predict_day(self, X_test, Start_time, slot,
        ...
        while t_now <=24.00:
            ...
            n_arrivals = n_arrivals[0] if(not isinstance(n_arrivals, int)) else n_arrivals
